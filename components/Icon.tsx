...
type IconName = 'upload' | 'trash' | 'wand' | 'download' | 'copy' | 'image' | 'palette' | 'plus' | 'chevron-down' | 'info' | 'chevron-left' | 'chevron-right' | 'sun' | 'moon';
...
// This ensures the type is correctly resolved from the imported React object.
const ICONS: Record<IconName, React.ReactElement> = {
  ...
  wand: <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.47 2.118 2.25 2.25 0 01-2.47-2.118c0-.498.158-.968.44-1.354a3 3 0 000-3.062 2.25 2.25 0 012.47-2.118 2.25 2.25 0 012.47 2.118c0 .498-.158.968-.44 1.354a3 3 0 005.78 1.128zM12.97 4.97a3 3 0 015.78-1.128 2.25 2.25 0 002.47-2.118 2.25 2.25 0 00-2.47-2.118c-.498 0-.968.158-1.354.44a3 3 0 01-3.062 0 2.25 2.25 0 00-2.118 2.47 2.25 2.25 0 002.118 2.47c.498 0 .968-.158 1.354-.44a3 3 0 011.128 5.78z" />,
